...
class TestGetErrors:
    ...
    def test_returns_no_errors_when_valid_metadata_is_provided(
        self, valid_metadata: RecordingMetadata
    ):
    ...
    def test_returns_an_error_for_each_invalid_metadata_field(
        self, valid_metadata: RecordingMetadata
    ):
    ...
    def test_returns_an_error_when_metadata_with_empty_file_path_is_provided(
        self, valid_metadata: RecordingMetadata
    ):
    ...
    def test_returns_an_error_when_metadata_with_nonexistent_file_is_provided(
        self, valid_metadata: RecordingMetadata
    ):
        valid_metadata.audio_file_path = Path("/nonexistent/path/sermon.mp3")
        errors = self.validator.get_errors(valid_metadata)
    ...
    def test_returns_an_error_when_metadata_with_empty_title_is_provided(
        self, valid_metadata: RecordingMetadata
    ):
        valid_metadata.title = ""
        errors = self.validator.get_errors(valid_metadata)
    ...
    def test_returns_an_error_when_metadata_with_empty_date_is_provided(
        self, valid_metadata: RecordingMetadata
    ):
        valid_metadata.date = ""
        errors = self.validator.get_errors(valid_metadata)
    ...
    def test_returns_an_error_when_metadata_with_invalid_date_is_provided(
        self, valid_metadata: RecordingMetadata, invalid_date: str
    ):
        valid_metadata.date = invalid_date
        errors = self.validator.get_errors(valid_metadata)
        assert "Please provide a date in YYYY.MM.DD format" in errors

    def test_returns_an_error_when_metadata_with_empty_speaker_name_is_provided(
        self, valid_metadata: RecordingMetadata
    ):
        valid_metadata.speaker_name = ""
        errors = self.validator.get_errors(valid_metadata)
